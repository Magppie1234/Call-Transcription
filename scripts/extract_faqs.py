...
PROMPT = """You are analysing a sales call transcript for Magppie, a premium modular kitchen company in India. The transcript is diarised and mostly romanised Hindi/Hinglish mixed with English.
