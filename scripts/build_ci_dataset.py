...
DEFAULT_OUT = Path("/Users/UNICA/Desktop/call transcription new/src/data/real/dataset.json")
...
def main():
    ...
    for cid, summ in summaries.items():
        ...
        calls.append({
            ...
            "productSeries": (enrich or {}).get("product_mentioned") or "Not specified",
            ...
            "intent": intent,
            "customerNeed": summ.get("kitchen_type") or summ.get("property_details"),
    ...
    dataset = {
        ...
        "sourceLabel": (f"Live Magppie data — {len(calls)} Zoho calls, Sarvam transcripts, "
