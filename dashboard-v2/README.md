# Magppie · Call Intelligence & Voice of Customer Dashboard
...
> **Live data.** The app runs on the real Magppie dataset: **722 Zoho CRM calls (1–24 July 2026)**,
...
> transcription repo). The original mock generator is still present and selectable with
> `DATA_MODE = 'mock'`.
>
