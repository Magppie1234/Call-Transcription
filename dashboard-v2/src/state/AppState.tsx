...
export const ROLE_PAGES: Record<Role, string[] | 'all'> = {
  Management: 'all',
  'Sales Manager': ['/', '/voice', '/faqs', '/regions', '/sales', '/agents', '/actions', '/calls', '/summaries', '/alerts'],
  'Service Manager': ['/', '/voice', '/faqs', '/agents', '/actions', '/calls', '/summaries', '/alerts'],
  'Quality Team': ['/voice', '/faqs', '/agents', '/calls', '/summaries', '/alerts', '/data'],
  Agent: ['/voice', '/faqs', '/actions', '/calls', '/summaries'],
};
